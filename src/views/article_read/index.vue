<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="readTime" label="访问时间" />
    ...
    >
      ...
      >
        ...
        <el-form-item label="访问时间" prop="readTime">
          <el-date-picker v-model="formData.readTime" type="datetime" placeholder="选择日期时间" />
        </el-form-item>
      ...
      >
        ...
        <el-descriptions-item label="访问时间">{{ formData.readTime }}</el-descriptions-item>
...
<script>
import * as api from '@/api/article_read'
export default {
  name: 'ArticleRead',
  data() {
    return {
      ...
      rules: {
        ...
        readTime: [{ required: true, message: '访问时间不能为空', trigger: 'blur' }],
