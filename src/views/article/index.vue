<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="publicType" label="公开类型 " />
    ...
    >
      ...
      >
        ...
        <el-form-item label="封面url" prop="coverUrl">
          <el-input v-model="formData.coverUrl" />
        </el-form-item>
        ...
        <el-form-item label="公开类型" prop="publicType">
          <el-input-number v-model="formData.publicType" />
        </el-form-item>
      ...
      >
        ...
        <el-descriptions-item label="封面url">{{ formData.coverUrl }}</el-descriptions-item>
        ...
        <el-descriptions-item label="发布时间">{{ formData.publishTime }}</el-descriptions-item>
        <el-descriptions-item label="公开类型">{{ formData.publicType }}</el-descriptions-item>
        <el-descriptions-item label="是否置顶">{{ formData.isTop }}</el-descriptions-item>
