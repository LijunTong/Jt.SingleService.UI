<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="isDel" label="是否删除" />
    </el-table>
    ...
    >
      ...
      <el-descriptions
        ...
        :column="2"
      >
        <el-descriptions-item label="栏目名称">{{ formData.name }}</el-descriptions-item>
        ...
        <el-descriptions-item label="是否删除">{{ formData.isDel }}</el-descriptions-item>
      </el-descriptions>
      <span
        v-show="dialogParams.type === 3"
        slot="footer"
