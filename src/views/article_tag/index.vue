    ...
    >
      ...
      >
        <el-form-item label="标签id" prop="tagId">
          <el-select v-model="formData.tagId" placeholder="请选择"><el-option v-for="item in [1,2,3]" :key="item" :label="item" :value="item" /></el-select>
        </el-form-item>
      ...
      <el-descriptions
        ...
        :column="2"
      >
        <el-descriptions-item label="标签id">{{ formData.tagId }}</el-descriptions-item>
...
<script>
import * as api from '@/api/article_tag'
export default {
  name: 'ArticleTag',
  data() {
    return {
