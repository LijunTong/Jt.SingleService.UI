    ...
    >
      ...
      >
        ...
        <el-form-item label="栏目id" prop="columnId">
          <el-select v-model="formData.columnId" placeholder="请选择"><el-option v-for="item in [1,2,3]" :key="item" :label="item" :value="item" /></el-select>
        </el-form-item>
      ...
      >
        ...
        <el-descriptions-item label="栏目id">{{ formData.columnId }}</el-descriptions-item>
...
<script>
import * as api from '@/api/article_column'
export default {
  name: 'ArticleColumn',
  data() {
    return {
